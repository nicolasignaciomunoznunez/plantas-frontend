...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Paleta de colores principal - Azul corporativo
        primary: {
          50: '#f0f9ff',
          100: '#e0f2fe',
          200: '#bae6fd',
      ...
      backgroundImage: {
        ...
        'gradient-dark': 'linear-gradient(135deg, #075985 0%, #0c4a6e 100%)',
        'gradient-light': 'linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%)',
        'gradient-hero': 'linear-gradient(135deg, rgba(14, 165, 233, 0.9) 0%, rgba(3, 105, 161, 0.9) 100%)',
      },
      boxShadow: {
